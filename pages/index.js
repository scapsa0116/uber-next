    ...
    <Wrapper>
      ...
      <ActionItems>
        ...
        <AcctionButtons>
          <Link href="/search">
          <AcctionButton>
            <AcctionButtonImage src="https://i.ibb.co/cyvcpfF/uberx.png"/>
            Ride
          </AcctionButton>
          </Link>

          <AcctionButton>
            <AcctionButtonImage src="https://i.ibb.co/n776JLm/bike.png"/>
            Wheels
          </AcctionButton>

          <AcctionButton>
             <AcctionButtonImage src="https://i.ibb.co/5RjchBg/uberschedule.png"/>
            Reserve
          </AcctionButton>
...
const AcctionButtons = tw.div`
flex 
`
const AcctionButton = tw.div`
flex bg-gray-200 flex-1 m-1 h-32 items-center flex-col rounded-lg transform hover:scale-105 transition text-xl cursor-pointer
`

const AcctionButtonImage = tw.img`
h-3/5
